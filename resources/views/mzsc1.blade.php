...
<div class="header">                   <!--头部-->
    ...
    <div class="nav">                                           <!--导航条-->
        <div class="header_left fl">
            ...
            <div onmouseout="leave_secondary_nav()" class="Secondary_navigation_ <?php echo $a.'bb' ?>"><!--二级导航栏，绝对定位块-->
        ...
        <div class="header_right fr">
            ...
            <?php if(session('user')){ ?>
            <div onmouseout="user_state_details()" onclick="Jump_Personal_Center()"  id="user_state_details" class="user_state_details_">用户：<?php echo $user_info['name']; ?><br>个人中心</div>
            ...
            <div class="main_phone">                      <!--手机-->
                ...
                <div class="main_phone_h">                <!--手机块头部-->
                    ...
                    <div class="phone_header_2 fl">
                        ...
                        <div class="phone_header_2_border">1</div>
                    </div>
                ...
                <div class="main_phone_m">               <!--手机块的主体-->
                    <div class="phone_t">
                        <div class="phone_top fl"><img src="./img/sj/sj1.png" alt=""></div>
                        <div class="phone_top fl"><img src="./img/sj/sj2.png" alt=""></div>
                        <div class="phone_top fl"><img src="./img/sj/sj3.png" alt=""></div>
                        <div class="phone_top fl"><img src="./img/sj/sj4.png" alt=""></div>
                        <div class="phone_top fl"><img src="./img/sj/sj5.png" alt=""></div>
                    </div>
                    <div class="phone_b">
                        <div class="phone_bottom fl"><img src="./img/sj/sj6.png" alt=""></div>
                        <div class="phone_bottom fl"><img src="./img/sj/sj7.png" alt=""></div>
                        <div class="phone_bottom fl"><img src="./img/sj/sj8.png" alt=""></div>
                        <div class="phone_bottom fl"><img src="./img/sj/sj9.png" alt=""></div>
                        <div class="phone_bottom fl"><img src="./img/sj/sj10.png" alt=""></div>
                    </div>
                </div>
            </div>                    <!--手机-->
